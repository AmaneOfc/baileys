...
/**
 * Returns true when message has a non-null, non-undefined property at key.
 */
...
const generateWAMessageContent = async (message, options) => {
    ...
    // ─── Button types (kept from shikimori) ──────────────────────────────────
    ...
    if ((hasOptionalProperty(message, 'mentions') && ((_o = message.mentions) === null || _o === void 0 ? void 0 : _o.length)) ||
